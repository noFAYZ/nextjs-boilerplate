...
function Overview2TabComponent() {
  ...
  return (
   ...
   <div className="h-full flex  gap-4">
      ...
      <div className="w-[22%] flex flex-col h-full shadow-none hover:shadow-none  overflow-hidden space-y-4 ">
          ...
          {groupedByType.assets.length > 0 && (
            <div className="space-y-3">
              <div className="flex items-center justify-between px-1">
                ...
                <Badge className={cn("font-bold tracking-widest rounded-xs  " )} variant={'success' }   >
          ASSETS
        </Badge>
                <div className="flex items-center gap-2">
                  <Badge className="bg-emerald-500/30 text-emerald-600  rounded-xs " size='icon'>
                   <PlusIcon className='w-3.5 h-3.5' strokeWidth={2.4} />
                  </Badge>
                  <span >
                    {balanceVisible ? (
                      <CurrencyDisplay amountUSD={groupedByType.assetsTotal || 0} className="   font-semibold text-foreground" variant='lg'/>
                    ) : (
                      <span>••••</span>
                    )}
                  </span>
                ...
                {groupedByType.assets.map((group) => {
                  ...
                  return (
                    <Button
                      ...
                      variant="ghost"
                      className={cn(
                        'w-full flex gap-3 px-3 py-2.5 rounded-xs transition-colors duration-0 text-left',
                        isActive
          ...
          {groupedByType.liabilities.length > 0 && (
            <div className="space-y-3">
              <div className="flex items-center justify-between px-1">
                ...
                <Badge className={cn("font-bold tracking-widest rounded-xs  uppercase" )} variant={ 'destructive'} >
                Liabilities
        </Badge>
                <div className="flex items-center gap-2">
                  <Badge className="bg-red-500/20 text-red-600 rounded-xs" size='icon'>
                  <MinusIcon className='w-3.5 h-3.5' strokeWidth={2.4} />
                  </Badge>
                  <span >
                    {balanceVisible ? (
                      <CurrencyDisplay amountUSD={groupedByType.liabilitiesTotal || 0} className="  font-semibold text-foreground" variant='lg'/>
                    ) : (
                      <span>••••</span>
                    )}
                  </span>
 ...
 {/*   <Button
         ...
         className="ml-4 font-semibold rounded-xs"
       >
   ...
   Account Grouping Section 
     {showGrouping && (
      ...
      <div className="flex-1 flex gap-4 min-w-0">
        {/* Center: Account Rows */}
        <div className="flex-1 flex flex-col  min-w-0 h-fit bg-card  rounded-xs border overflow-hidden"> 

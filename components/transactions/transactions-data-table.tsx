...
export function TransactionsDataTable({
  ...
  const [selectedTransactionForAttachment, setSelectedTransactionForAttachment] = useState<UnifiedTransaction | null>(null);
                    ...
                    >
                      ...
                      <TableCell className="text-center w-[8%]">
                        ...
                        >
                          ...
                          <span className="text-xs text-muted-foreground group-hover:text-foreground font-medium transition-colors">0</span>
                        </button>
                      </TableCell>
...
function AttachmentModal({ isOpen, transaction, onClose }: AttachmentModalProps) {

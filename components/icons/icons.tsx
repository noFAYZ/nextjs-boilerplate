  ...
  export function LogoMapprsss(props: SVGProps<SVGSVGElement>) {
	return (<svg
	  ...
	  >
		...
		<g id="SVGRepo_iconCarrier">
		  {" "}
		  <title>dead_star [#38]</title> <desc>Created with Sketch.</desc>{" "}
		  <defs> </defs>{" "}
		  <g id="Page-1" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
			{" "}
			<g
			  id="Dribbble-Light-Preview"
			  transform="translate(-60.000000, -8039.000000)"
			  fill="currentColor"
			>
			  {" "}
			  <g id="icons" transform="translate(56.000000, 160.000000)">
				{" "}
				<path
				  d="M14.5356,7892.5355 C12.5816,7894.4895 9.4186,7894.4895 7.4646,7892.5355 C5.5146,7890.5855 5.5146,7887.4135 7.4646,7885.4645 C9.4186,7883.5105 12.5816,7883.5105 14.5356,7885.4645 C16.4846,7887.4135 16.4846,7890.5855 14.5356,7892.5355 M21.0706,7881.9285 C17.1656,7878.0235 10.8346,7878.0235 6.9286,7881.9285 C3.0246,7885.8335 3.0226,7892.1645 6.9286,7896.0715 C10.8336,7899.9765 17.1656,7899.9765 21.0706,7896.0715 C24.9766,7892.1655 24.9766,7885.8345 21.0706,7881.9285"
				  id="dead_star-[#38]"
				>
				  {" "}
				</path>{" "}

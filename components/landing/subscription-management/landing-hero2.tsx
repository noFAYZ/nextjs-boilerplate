...
export function LandingHero() {
  ...
  return (
    <section className="relative overflow-hidden min-h-screen flex justify-between">
 ...
 {/*      <div
      ...
      />*/}
      <BgGradient pattern={false} className="m-9 rounded-xl border shadow over" imageSrc="/landing/bg4.png" opacity="0" imageOpacity={0.78} />
  ...
  />*/}
      ...
      <div className="relative z-10 flex flex-col justify-end  max-w-lg lg:max-w-lg xl:max-w-3xl text-start p-20 ">
        {/* Heading */}
        <motion.h1
          {...fadeUp}
        ...
        <motion.p
          ...
          className="pl-2 mt-4 max-w-lg text-sm sm:text-sm md:text-md lg:text-base text-foreground/80 text-start"
        >
...
<div
        ...
        {/* Dashboard Preview
         ...
         <motion.div
            ...
            className="relative mx-auto max-w-7xl 0"
            style={{
              zIndex: -10
            }}
          >

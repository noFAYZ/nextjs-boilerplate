  ...
  return (
    <>
      <nav className={cn('fixed inset-x-0 top-0 z-50', isScrolled ? 'py-2' : 'py-4')}>
        <div className={cn('mx-auto transition-all duration-200 border ', isScrolled ? 'max-w-5xl  rounded-lg bg-gradient-to-br from-muted/95 via-muted to-accent/95  border-border/50 dark:from-muted shadow-sm dark:via-background dark:to-muted ' : 'max-w-7xl  rounded-lg bg-gradient-to-br from-muted/95 via-muted to-accent/95  border-border/50 dark:from-muted shadow-sm dark:via-muted/50 dark:to-muted')}>

...
const buttonVariants = cva(
 ...
 /*        default:
        ...
        secondary:  "bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/80 hover:shadow-md active:scale-[0.98] backdrop-blur-sm border-2 border-orange-500/10 shadow-[0_3px_0_0_rgb(254,215,170)] hover:shadow-[0_1px_0_0_rgb(254,215,170)] hover:translate-y-[2px] active:shadow-none active:translate-y-[3px] transition-all duration-75 dark:border-[rgb(114,65,12)] dark:shadow-[0_3px_0_0_rgb(114,65,12)] dark:hover:shadow-[0_1px_0_0_rgb(114,65,12)]",
        ghost:

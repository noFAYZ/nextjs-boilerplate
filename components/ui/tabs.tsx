  ...
  "inline-flex items-center justify-center gap-2 w-fit",
  {
    variants: {
      variant: {
        ...
        card: "bg-muted rounded-xl p-0.5 shadow-xs border",
  ...
  "inline-flex items-center  gap-2 font-medium whitespace-nowrap transition-all duration-100 ease-out relative cursor-pointer select-none",
  {
    variants: {
      variant: {
        ...
        card: "rounded-xl px-4 py-3 text-muted-foreground hover:text-foreground hover:bg-muted/50 data-[state=active]:bg-background data-[state=active]:shadow-sm data-[state=active]:text-foreground border border-transparent data-[state=active]:border-border",
        ...
        pill: "rounded-full px-4 py-2 border border-border text-muted-foreground hover:text-foreground hover:bg-muted/50 data-[state=active]:bg-foreground data-[state=active]:text-background",

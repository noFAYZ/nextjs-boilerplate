  ...
  "inline-flex items-center justify-center gap-2 w-fit",
  {
    variants: {
      variant: {
        ...
        card: "bg-card rounded-lg p-0.5 shadow-xs border border-border/80",
        minimal: "bg-transparent border-b border-border",
        ghost: "bg-transparent rounded-2xl p-1",
        pill: "bg-transparent rounded-lg p-1",
  ...
  "inline-flex items-center  gap-2 font-medium whitespace-nowrap transition-all duration-100 ease-out relative cursor-pointer select-none",
  {
    variants: {
      variant: {
        ...
        card: "rounded-lg px-4 py-3 text-muted-foreground hover:text-foreground hover:bg-muted/50 data-[state=active]:bg-background data-[state=active]:shadow-sm data-[state=active]:text-foreground border border-transparent data-[state=active]:border-border/80",
        ...
        ghost: "py-3 px-2 hover:bg-card   data-[state=active]:bg-card data-[state=active]:hover:bg-card/70 data-[state=active]:border-b",
        ...
        pill: "rounded-full px-4 py-2 border border-border bg-card text-muted-foreground hover:text-foreground hover:bg-muted/50 data-[state=active]:bg-foreground data-[state=active]:text-background",

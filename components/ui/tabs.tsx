  ...
  "inline-flex items-center  gap-2 font-medium whitespace-nowrap transition-all duration-75 ease-out relative cursor-pointer select-none",
  {
    variants: {
      variant: {
        ...
        minimal: "rounded-none border-b-2 border-transparent px-4 py-3 text-muted-foreground hover:text-foreground hover:border-border data-[state=active]:border-primary/80 data-[state=active]:text-foreground",

...
const inputVariants = cva(
  "file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground flex w-full min-w-0 border bg-background backdrop-blur-sm text-base transition-all duration-75 outline-none file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
  {
    variants: {
      variant: {
        default: "  rounded-sm shadow-none  ",
        filled: "bg-secondary/95 border-transparent rounded-lg hover:bg-secondary/90",
        ...
        outline:'rounded-lg shadow bg-card'
      },
      size: {

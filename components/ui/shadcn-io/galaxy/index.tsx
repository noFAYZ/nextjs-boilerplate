...
export const Galaxy = forwardRef<HTMLDivElement, GalaxyProps>(({
  ...
  delete domProps.focal;
  delete domProps.rotation;
  delete domProps.starSpeed;
  delete domProps.density;
  delete domProps.hueShift;
  delete domProps.disableAnimation;
  delete domProps.speed;
  delete domProps.mouseInteraction;
  delete domProps.glowIntensity;
  delete domProps.saturation;
  delete domProps.mouseRepulsion;
  delete domProps.twinkleIntensity;
  delete domProps.rotationSpeed;
  delete domProps.repulsionStrength;
  delete domProps.autoCenterRepulsion;

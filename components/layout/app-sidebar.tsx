...
const defaultNavigation: SidebarNavItem[] = [
  ...
  },
  {
    ...
    icon: Wallet,
    children: [
      { title: "All Wallets", href: "/dashboard/crypto/wallets", icon: Wallet },
      { title: "Add Wallet", href: "/dashboard/crypto/wallets/add", icon: Plus },
      { title: "Import/Export", href: "/dashboard/crypto/import-export", icon: Download },
    ],
  },
  {
    title: "Accounts",
    icon: CreditCard,
    children: [
      { title: "All Accounts", href: "/dashboard/accounts", icon: CreditCard },
      { title: "Account Groups", href: "/dashboard/accounts/groups", icon: Users },
      { title: "Add Account", href: "/dashboard/accounts/add", icon: Plus },
    ],
  },
  {
    title: "Analytics",
    icon: BarChart3,
    children: [
      { title: "Portfolio Analytics", href: "/dashboard/analytics", icon: PieChart },
      { title: "Performance", href: "/dashboard/analytics/performance", icon: TrendingUp },
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Import/Export", href: "/dashboard/settings/import-export", icon: Upload },
    ],
  },
  {
    title: "Help & Support",

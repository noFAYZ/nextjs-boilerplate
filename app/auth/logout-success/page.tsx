      ...
      <Card className="relative w-full max-w-md p-8 bg-gradient-to-br from-card/50 via-card/60 to-card/50 backdrop-blur-xl border-2 border-border/50 shadow-2xl">
        ...
        <div className="relative flex flex-col items-center space-y-6">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-indigo-500/20 rounded-full blur-xl animate-pulse" />
            <div className="relative w-20 h-20 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center animate-scale-in">
          ...
          <div className="w-full space-y-2">
            ...
            <p className="text-xs text-center text-muted-foreground">
              Redirecting to login... {Math.round(progress)}%
            </p>
          </div>
